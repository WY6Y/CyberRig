...
| **REMOTE TUNE** | Carrier for an *external* auto-tuner (e.g. MFJ) — **not** the FTDX10 internal ATU |
...
- REMOTE TUNE is for an **external** tuner carrier path; it is not a substitute
  for the radio’s internal ATU menu.
